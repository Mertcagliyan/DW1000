...
#define ANCHOR_ADD "82:19:5N:A5:K7:2A:E8:3C" // Anchor address
#define TAG_ADD "80:19:2C:F5:G5:1B:L3:1C" // Tag address
...
void loop()
{
  if(firstTest1 == 1 && firstTest2 == 2 && secondTest4 == 4){
    if (!isAnchor) {
            // Start as anchor
            DW1000Ranging.startAsAnchor(ANCHOR_ADD, DW1000.MODE_LONGDATA_RANGE_LOWPOWER, false);
        } else {
